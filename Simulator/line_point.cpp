                ...
                foreach(auto dt, this->DT){
                    ...
                    if(dt != DT){
                        ...
                        if(dt->R_N){
                            ...
                            painter->drawLine(this->LP.last().x() + 5, this->LP.last().y() + 1, this->LP.first().x() + 0, this->LP.last().y() + 1);//++

                        }else if(dt->L_V){

                            painter->drawLine(this->LP.first().x() - 6,this->LP.first().y() + 1, this->LP.last().x() + 1 , this->LP.first().y() + 1);//++
                            painter->drawLine(this->LP.last().x() + 0, this->LP.last().y() + 7, this->LP.last().x() + 0, this->LP.first().y() + 0);//++
            ...
            {qDebug() << "4.2 четверть";// + -
                ...
                foreach(auto dt, this->DT){
                    ...
                    if(dt != DT){
                        ...
                        if(dt->R_N){
                            qDebug() << "4.2.1 четверть";// + +

                            painter->drawLine(this->LP.first().x() + 0,this->LP.first().y() - 5, this->LP.first().x() + 0 , this->LP.last().y() + 1);//++
                            painter->drawLine(this->LP.last().x() + 6, this->LP.last().y() + 1, this->LP.first().x() + 0, this->LP.last().y() + 1);//++

                        }else if(dt->L_V){
                            qDebug() << "4.2.2 четверть";// + +

                            painter->drawLine(this->LP.first().x() - 5,this->LP.first().y() + 1, this->LP.last().x() + 1 , this->LP.first().y() + 1);// ++
                            painter->drawLine(this->LP.last().x() + 1, this->LP.last().y() + 6, this->LP.last().x() + 1, this->LP.first().y() + 1);// ++
                ...
                foreach(auto dt, this->DT){
                    ...
                    if(dt != DT){
                        ...
                        if(dt->R_N){
                            ...
                            painter->drawLine(this->LP.first().x() + 0,this->LP.first().y() + 6, this->LP.first().x() + 0 , this->LP.last().y() + 1);//++
                            painter->drawLine(this->LP.last().x() - 5, this->LP.last().y() + 1, this->LP.first().x() + 1, this->LP.last().y() + 1);//++
            ...
            {qDebug() << "2.2 четверть";//+
                ...
                foreach(auto dt, this->DT){
                    ...
                    if(dt != DT){
                        ...
                        if((dt->OL == vertically) &&((DT->ort  == From_top_To_bottom) | (DT->ort == From_bottom_To_top ))){



                            if(dt->R_N){
                                qDebug() << "2.2.1 четверть";//+

                                painter->drawLine(this->LP.first().x() + 6,this->LP.first().y() + 1, this->LP.last().x() + 0 , this->LP.first().y() + 1);//+
                                painter->drawLine(this->LP.last().x() + 1, this->LP.first().y() + 1, this->LP.last().x() + 1, this->LP.last().y() - 5);//++

                            }else if(dt->L_V){
                                qDebug() << "2.2.2 четверть";//+
                        ...
                        }else if((dt->OL == horizontally) |(dt->ort  == From_top_To_bottom)| (DT->ort ==  From_left_To_right) | (DT->ort == From_right_To_left)){

                            if((DT->ort ==  From_left_To_right) | (DT->ort == From_right_To_left)){//+

                                if(dt->R_N){
                                    qDebug() << "2.2.3 четверть";//+

                                    painter->drawLine(this->LP.first().x() + 6,this->LP.first().y() + 1, this->LP.last().x() + 0 , this->LP.first().y() + 1);//+
                                    painter->drawLine(this->LP.last().x() + 1, this->LP.first().y() + 1, this->LP.last().x() + 1, this->LP.last().y() - 5);//++

                                }else if(dt->L_V){
                                    qDebug() << "2.2.4 четверть";//+
                                ...
                                if(dt->R_N){
                                    qDebug() << "2.2.5 четверть";//+

                                    painter->drawLine(this->LP.first().x() + 0,this->LP.first().y() + 7, this->LP.first().x() + 0 , this->LP.last().y() + 0);//++
                                    painter->drawLine(this->LP.last().x() - 5, this->LP.last().y() + 0, this->LP.first().x() + 0, this->LP.last().y() + 0);//++

                                }else if(dt->L_V){
                                    qDebug() << "2.2.6 четверть";//+
        ...
        foreach(auto DT, this->DT)
        {
            ...
            if((DT->pos().x() == LP.first().x()) && (DT->pos().y() == LP.first().y()) && (DT->R_N))
            {
                ...
                foreach(auto dt, this->DT){
                    ...
                    if(dt != DT){
                        ...
                        if((dt->OL == horizontally) | (dt->ort == From_top_To_bottom) | (dt->ort == From_bottom_To_top)){
            ...
            {qDebug() << "1.2 четверть";
                ...
                foreach(auto dt, this->DT){
                    ...
                    }else if((dt->OL == vertically) | (dt->ort == From_bottom_To_top) | (dt->ort == From_top_To_bottom)){
                    ...
                    if(dt != DT){
                        ...
                        if(dt->OL == horizontally){
                            ...
                            if(dt->R_N){
                                ...
                                painter->drawLine(this->LP.first().x() + 6,this->LP.first().y() + 0, this->LP.last().x() + 0 , this->LP.first().y() + 0);//++
                                painter->drawLine(this->LP.last().x() + 0, this->LP.last().y() + 7, this->LP.last().x() + 0, this->LP.first().y() + 0);//++
                    ...
                    if(dt->OL == horizontally){
                        ...
                        if(dt != DT){
                            ...
                            if(dt->R_N){
                                ...
                                painter->drawLine(this->LP.first().x() + 5,this->LP.first().y() + 1, this->LP.last().x() + 1 , this->LP.first().y() + 1);//++
                                painter->drawLine(this->LP.last().x() + 1, this->LP.last().y() + 7, this->LP.last().x() + 1, this->LP.first().y() + 1);//++
